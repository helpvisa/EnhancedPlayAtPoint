...
These scripts include a clip tester and a very basic form of audio occlusion. In order for audio occlusion to properly
work, your listener must have a collider. Audio occlusion can be disabled when calling the method.
Instantiated clips can also be told to follow a specific transform after being created using an overload function.
